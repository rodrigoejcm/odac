...
# the cluster size of the child cluster has to grow bigger than the parent cluster
...
# but in order for the aggregation function to apply, we need to increase the cluster sizes
